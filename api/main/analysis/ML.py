...
clf = pickle.load(open(os.path.join(os.path.dirname(__file__), 'model.pickle'), 'rb'))

Data = pd.read_csv(os.path.join(os.path.dirname(__file__), 'ISEAR.csv'),header=None)
